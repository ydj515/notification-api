...
class TrustedHostMiddleware:
    def __init__(
        ...
        except_path: typing.Sequence[str] = None, # 기존 starlette에다가 추가한 것임. ex) data.go.kr의 도메인으로만 들어온 경로만 유효 증명이라고 하기 위해 심었음. ec2에서 로드밸런서의 헬스 체크(내부ip를 사용)를 하기 위해서. 없으면 헬스체크가 전부 fail
